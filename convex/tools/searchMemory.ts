    ...
    try {
      ...
      if (memories.length === 0) {
        return {
          success: true,
          found: false,
          message: "I don't have any stored memories yet. As we talk more, I'll remember important things.",
        };
      }
...
If no good match, return empty arrays and low confidence.`,
      ...
      return {
        ...
        context: `Found from conversation on ${new Date(matchedMemories[0].timestamp).toLocaleDateString()}`,
      };
