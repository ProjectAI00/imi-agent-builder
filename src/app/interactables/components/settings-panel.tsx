          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Visual search and inspiration</p>
                  </div>
                </div>
                <button 
                  onClick={() => window.open('/pinterest-integration', '_blank')}
              ...
              <p className="text-xs text-gray-500">
                Connect Pinterest to enable AI-powered visual search and pin recommendations in your chat.
              </p>
            </div>
          </div>
        </div>
